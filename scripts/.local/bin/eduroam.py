...
Messages.user_cert_missing = "No se ha encontrado un certificado " \
    "personal"
Config.instname = "Universidad del País Vasco"
Config.profilename = "EHU"
Config.url = "http://www.ehu.eus/wifi/"
Config.email = "cau@ehu.eus"
Config.title = "eduroam CAT"
Config.server_match = "freeradius.ehu.es"
...
Config.user_realm = "ehu.es"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:freeradius.ehu.es']
...
-----END CERTIFICATE-----
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
run_installer()
